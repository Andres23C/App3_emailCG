...
public class EmailAdapter extends RecyclerView.Adapter<EmailAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.emTextView.setText(email.getEmail());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null) {
                    ...
                    holder.emTextView.setTextColor(ContextCompat.getColor(context, R.color.white));
                    ...
                    holder.dateTextView.setTextColor(ContextCompat.getColor(context, R.color.white_dark));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            emTextView = itemView.findViewById(R.id.emTextView);
